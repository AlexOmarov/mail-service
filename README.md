...
* Вызов других внутренних сервисов подсистемы
...
- Postgres база (v. 15 и выше). Стандартные конфиги (с именами системных переменных):
  ...
  - port: ${DB_PORT:5432}
  - name: ${DB_DATABASE:appeal_service}
  - schema: ${DB_SCHEMA:appealdb}
  - user: ${DB_USER_NAME:appeal_service}
  - password: ${DB_PASSWORD:appeal_service}
